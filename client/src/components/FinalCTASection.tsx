...
export default function FinalCTASection() {
  return (
    <section className="py-16 md:py-24 bg-gradient-to-br from-customTertiary/40 to-customTertiary">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <Button
            size="lg"
            className="border-white bg-white text-customTertiary hover:bg-white/80"
            asChild
          ...
          <Button
            size="lg"
            variant="outline"
            className="border-customPrimary text-white bg-transparent hover:bg-customTertiary/50"
            asChild
